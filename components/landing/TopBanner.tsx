export const TopBanner = ({ data }: { data: any }) => (
    <>
        <section className="mb-5">
            <div style={{ backgroundColor: data.title_bg || '#004d26' }} className="max-w-6xl mx-auto rounded-[10px] py-6 px-4 ">
        ...
        <section>
            <div style={{ backgroundColor: data.subtitle_bg || '#FCD34D' }} className="max-w-6xl mx-auto text-center shadow-inner py-6 px-4 rounded-[10px]">
